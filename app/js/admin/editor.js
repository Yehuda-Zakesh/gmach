      ...
      var body = Dom.h('div.editor-grid', {}, [
        ...
        item.source === 'bundled'
          ? Dom.h('div.notice.notice--info', {}, [
              ...
              Dom.h('div', {
                text:
                  'פריט מובנה — מתעדכן אוטומטית מהרשת בכל פתיחת האפליקציה. ' +
                  'הגרסה, שם הקובץ והנתיב מנוהלים אוטומטית ויידרסו בעדכון הבא; ' +
                  'שאר השדות (תיאור, קטגוריה, תגיות וכו׳) ניתנים לעריכה חופשית.',
              }),
            ])
          : null,
      ]);
